...
import './style.css';
import contact from "../assets/conta.jpg";
...
<div className='w-full mt-14 flex mt-3 bg-stone-900 relative'>
  <div className='w-1/2 flex flex-col justify-center items-center p-8 text-white bg-black z-10'>
    <form className="max-w-sm mx-auto">
      ...
      <input 
        ...
        placeholder="Phone"
      />
      <label htmlFor="subscription" className="block mb-2 text-sm font-medium text-white dark:text-white">Select your subscription</label>
